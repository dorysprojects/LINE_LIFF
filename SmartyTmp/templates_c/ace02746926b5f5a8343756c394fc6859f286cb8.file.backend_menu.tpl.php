<?php /* Smarty version Smarty3-b7, created on 2022-01-05 11:23:08
         compiled from "/home1/bot.gadclubs.com//library/modules/_public/view/backend_menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:130638622961d50f1c8de898-09789059%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ace02746926b5f5a8343756c394fc6859f286cb8' => 
    array (
      0 => '/home1/bot.gadclubs.com//library/modules/_public/view/backend_menu.tpl',
      1 => 1641352730,
    ),
  ),
  'nocache_hash' => '130638622961d50f1c8de898-09789059',
  'function' => 
  array (
  ),
            ...
            <?php if ($_smarty_tpl->getVariable('_authority')->value){?>
                ...
                <li id="SideBar_FB" class="header">
                    ...
                    <?php if ($_smarty_tpl->getVariable('_authority')->value['CustomerService']['index']==='on'&&$_smarty_tpl->getVariable('_authority')->value['CustomerService']['facebook']==='on'){?>
                        <li class="SideBar_FB SideBar_FacebookChat <?php if ($_smarty_tpl->getVariable('_Module')->value=='CustomerService'){?>active<?php }?>"><a href="/be/CustomerService/index/ChatRoom/facebook" target="_blank"><i class="fa fa-fw fa-headphones"></i> <span>線上客服</span></a></li>
                    <?php }?>
                ...
                <li id="SideBar_Line" class="header">
                    ...
                    <?php if ($_smarty_tpl->getVariable('_authority')->value['CustomerService']['index']==='on'&&$_smarty_tpl->getVariable('_authority')->value['CustomerService']['line']==='on'){?>
                        <li class="SideBar_Line SideBar_LineChat <?php if ($_smarty_tpl->getVariable('_Module')->value=='CustomerService'){?>active<?php }?>"><a href="/be/CustomerService/index/ChatRoom/line" target="_blank"><i class="fa fa-fw fa-headphones"></i> <span>線上客服</span></a></li>
                    <?php }?>
