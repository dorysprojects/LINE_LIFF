<?php /* Smarty version Smarty3-b7, created on 2021-11-24 19:04:25
         compiled from "/home1/rickytest.gadclubs.com/CustomStickers/library/modules/frontend/view/sticker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:390539283619e1c39a5f883-36042600%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6cc376b0e8a57a5075268964c55e65f17c8482d2' => 
    array (
      0 => '/home1/rickytest.gadclubs.com/CustomStickers/library/modules/frontend/view/sticker.tpl',
      1 => 1636350791,
    ),
  ),
  'nocache_hash' => '390539283619e1c39a5f883-36042600',
  'function' => 
  array (
  ),
...
<html>
 ...
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
        ...
        <div id="upload_area">
            <?php echo $_smarty_tpl->getVariable('Html_close2')->value;?>

            <div id="UploadLocalFile">上傳本地檔案:</div>
            <?php echo $_smarty_tpl->getVariable('Html_upload_form')->value;?>
        ...
        <div id="signature-pad" class="signature-pad">
            <div style="display:none;">
                <select id="choose_user" class="selector" onchange="choose_user(this);">
                    <option value="全部">全部 (<?php echo count($_smarty_tpl->getVariable('store_names')->value);?>
)</option>
                    <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('store_names')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if (count($_from) > 0){
...
(<?php echo $_smarty_tpl->getVariable('search_store_all_names')->value[$_smarty_tpl->getVariable('item')->value];?>
</option>
                    <?php }} ?>
                </select>
            </div>
            ...
            <div class="signature-pad--body" style="overflow:auto;">
                ...
                <div id="list_area" style="height: 100%;">
                    <?php if ($_smarty_tpl->getVariable('userId')->value!=''){?>
                        <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('store_list')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if (count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
                            <div id="push_pic<?php echo $_smarty_tpl->getVariable('key')->value+1;?>
" ctn="<?php echo $_smarty_tpl->getVariable('key')->value;?>
" data-id="<?php echo $_smarty_tpl->getVariable('item')->value['id'];?>
" class="pic_block" onclick="push_pic($(this));">
                                <?php if ((substr($_smarty_tpl->getVariable('item')->value['propertyB'],-3))=='mp4'){?>
                                    <!--<video class='pic' crossorigin='anonymous' src='<?php echo $_smarty_tpl->getVariable('item')->value['propertyB'];?>
' autoplay></video>
                                    <svg width="20" height="20" style="position:absolute;margin-left:-20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                                        <path id="heart<?php echo $_smarty_tpl->getVariable('key')->value+1;?>
" style="transition:fill ease-in .5s;<?php if ($_smarty_tpl->getVariable('item')->value['viewA']=='true'){?>fill:rgb(206, 61, 61);<?php }else{ ?>fill:#fff;<?php }?>" stroke="rgb(206, 61, 61)" stroke-width="40" stroke-linejoin="round" d="M412 79c-53-40-146-17-162 68-16-85-109-108-162-68-43 32-55 94-44 137 30 119 194 217 206 224 12-7 176-105 206-224 11-43-1-105-44-137z"></path>
                                    ...
                                    <img class='pic' crossorigin='anonymous' src='<?php echo $_smarty_tpl->getVariable('item')->value['propertyB'];?>
'>
                                    <svg width="20" height="20" style="position:absolute;margin-left:-20px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                                        <path id="heart<?php echo $_smarty_tpl->getVariable('key')->value+1;?>
" style="transition:fill ease-in .5s;<?php if ($_smarty_tpl->getVariable('item')->value['viewA']=='true'){?>fill:rgb(206, 61, 61);<?php }else{ ?>fill:#fff;<?php }?>" stroke="rgb(206, 61, 61)" stroke-width="40" stroke-linejoin="round" d="M412 79c-53-40-146-17-162 68-16-85-109-108-162-68-43 32-55 94-44 137 30 119 194 217 206 224 12-7 176-105 206-224 11-43-1-105-44-137z"></path>
                ...
                <div id="addarea" style="">
                    ...
                    <div id="change_width" class="EditArea" style="">
                        ...
                        <select id="select_width" class="selector" onchange="select_width(this);" /*data-action="select_width"*/>
                            <?php $_smarty_tpl->tpl_vars['trg'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['trg']->step = (30 - (1) < 0) ? -1 : 1;$_smarty_tpl->tpl_vars['trg']->total = (int)ceil(($_smarty_tpl->tpl_vars['trg']->step > 0 ? 30+1 - 1 : 1-(30)+1)/abs($_smarty_tpl->tpl_vars['trg']->step));
if ($_smarty_tpl->tpl_vars['trg']->total > 0){
for ($_smarty_tpl->tpl_vars['trg']->value = 1, $_smarty_tpl->tpl_vars['trg']->iteration = 1;$_smarty_tpl->tpl_vars['trg']->iteration <= $_smarty_tpl->tpl_vars['trg']->total;$_smarty_tpl->tpl_vars['trg']->value += $_smarty_tpl->tpl_vars['trg']->step, $_smarty_tpl->tpl_vars['trg']->iteration++){
$_smarty_tpl->tpl_vars['trg']->first = $_smarty_tpl->tpl_vars['trg']->iteration == 1;$_smarty_tpl->tpl_vars['trg']->last = $_smarty_tpl->tpl_vars['trg']->iteration == $_smarty_tpl->tpl_vars['trg']->total;?>
                                <option value="<?php echo $_smarty_tpl->getVariable('trg')->value;?>
"><?php echo $_smarty_tpl->getVariable('trg')->value;?>
</option>
                            <?php }} ?>
                        </select>
                    </div>
                    ...
                    <div id="change_word" class="EditArea" style="padding:50px 0px;">
                        ...
                        <select id="select_family" class="selector" style="display:none">
                            <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('family')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if (count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
...
"><?php echo $_smarty_tpl->getVariable('BubbleSizeZhTw')->value[$_smarty_tpl->getVariable('item')->value];?>
 ...
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
        ...
        <script>
            var store_datetime = ["<?php echo $_smarty_tpl->getVariable('store_datetime')->value;?>
"];
...
';
                ...
                if ('<?php echo $_smarty_tpl->getVariable('userId')->value;?>
' == '') {
                    location.href = '<?php echo $_smarty_tpl->getVariable('__CustomStickers_Web')->value;?>
/?sticker?' + 'project=手畫貼圖' + '&pic_url=' + pic_url + '&userId=' + userId;
                }

                if (ManagerList.indexOf(userId) != '-1') {
                    more = 'true';
                    store_all_id = ["<?php echo $_smarty_tpl->getVariable('store_all_id')->value;?>
"];
                    store_all_pic = ["<?php echo $_smarty_tpl->getVariable('store_all_pic')->value;?>
"];
                    store_all_name = ["<?php echo $_smarty_tpl->getVariable('store_all_name')->value;?>
"];
                    store_all_profile_pic = ["<?php echo $_smarty_tpl->getVariable('store_all_profile_pic')->value;?>
"];
                    store_all_profile_statusMessage = ["<?php echo $_smarty_tpl->getVariable('store_all_profile_statusMessage')->value;?>
"];
                    store_all_datetime = ["<?php echo $_smarty_tpl->getVariable('store_all_datetime')->value;?>
"];
                    store_all_favorite = ["<?php echo $_smarty_tpl->getVariable('store_all_favorite')->value;?>
"];
...
/core/func/kPrewPic.php', {
            ...
            $(function () {
                <?php if ($_smarty_tpl->getVariable('imgur_result')->value){?>
                    $('#imgur_result').val('<?php echo $_smarty_tpl->getVariable('imgur_result')->value;?>
');
                    $('#upload_area').show();
                <?php }?>
                ...
                if ($('#list_area').children().length > 1) {
                    $('#canvas').css('visibility', 'hidden').hide();
