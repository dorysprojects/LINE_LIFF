<?php /* Smarty version Smarty3-b7, created on 2023-09-21 15:02:03
         compiled from "/home1/bot.lineapie.tw/library/modules/frontend/view/place.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2031165568650bea6b7ac958-00183770%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '811392be72cfc7b81adce07e555c879e66aa7483' => 
    array (
      0 => '/home1/bot.lineapie.tw/library/modules/frontend/view/place.tpl',
      1 => 1695279723,
    ),
  ),
  'nocache_hash' => '2031165568650bea6b7ac958-00183770',
  'function' => 
  array (
  ),
 ...
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
            ...
            <div id="place_add_background" class="press_background">
                <div id="place_add_background_area" class="press_button_area">
                    ...
                    <?php if (!$_smarty_tpl->getVariable('SelectStrokeItem')->value||$_smarty_tpl->getVariable('userId')->value==$_smarty_tpl->getVariable('SelectStrokeItem')->value['propertyA']){?>
...
" class="form-control costItem" onchange="updateTotal();" min="0" placeholder="金額" />
                                </div>
                            <?php }} ?>
                        </div>
                    </div>
...
"><?php echo $_smarty_tpl->getVariable('subcategoryitem')->value['propertyB'];?>
        ...
        <script>
            ...
            var _userList=<?php echo json_encode($_smarty_tpl->getVariable('userList')->value);?>
                    ...
                    if(carouselContent.length > 0){
                        ...
                        for (const [actionKey, actionItem] of Object.entries(actionList)) {
                            actionContents.push({
                                ...
                                "action": {
                                    "type": "uri",
                                    "uri": "https://liff.line.me/<?php echo $_smarty_tpl->getVariable('liffId')->value;?>
/page/place/stroke/<?php echo $_smarty_tpl->getVariable('SelectStroke')->value;?>
/EditArea/"+actionItem['EditArea']+"/?project=<?php echo $_smarty_tpl->getVariable('ProjectName')->value;?>
"
                                }
                            });
                        }
                                ...
                                "contents": [
                                    {
                                        ...
                                        "contents": [
                                            {
                                                "type": "text",
                                                "text": "<?php echo $_smarty_tpl->getVariable('ProjectName')->value;?>
 - "+$('#TripName').val(),
                                                "weight": "bold",
                                                "align": "center",
                                                "size": "lg"
                ...
                <?php if ($_smarty_tpl->getVariable('EditArea')->value){?>
                    $('.EditArea').hide();
                    $('#<?php echo $_smarty_tpl->getVariable('EditArea')->value;?>
').show();
                    scrollToLast('<?php echo $_smarty_tpl->getVariable('EditArea')->value;?>
');
                <?php }?>
            });
