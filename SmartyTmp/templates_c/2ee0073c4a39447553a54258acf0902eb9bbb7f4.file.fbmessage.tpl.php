<?php /* Smarty version Smarty3-b7, created on 2021-06-28 15:55:14
         compiled from "/home1/rickytest.gadclubs.com/CustomStickers/library/modules/_public/view/type/fbmessage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22250673060d98062a06b23-60785191%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ee0073c4a39447553a54258acf0902eb9bbb7f4' => 
    array (
      0 => '/home1/rickytest.gadclubs.com/CustomStickers/library/modules/_public/view/type/fbmessage.tpl',
      1 => 1624866823,
    ),
  ),
  'nocache_hash' => '22250673060d98062a06b23-60785191',
  'function' => 
  array (
  ),
...
$_smarty_tpl->tpl_vars['G']->first = $_smarty_tpl->tpl_vars['G']->iteration == 1;$_smarty_tpl->tpl_vars['G']->last = $_smarty_tpl->tpl_vars['G']->iteration == $_smarty_tpl->tpl_vars['G']->total;?>
            ...
            <div class="col-lg-4 Template" style="display:inline-block;width:300px;margin: 10px;text-align:center;">
                <div class="TemplateBtn" style="width:300px;height:35px;">
                    ...
                    <div id="fbEditMsg<?php echo $_smarty_tpl->getVariable('G')->value;?>
" class="btn btn-success" style="float:right;" msgctn="<?php echo $_smarty_tpl->getVariable('G')->value;?>
" onclick="fbEditMsg(<?php echo $_smarty_tpl->getVariable('G')->value;?>
);">編輯訊息</div>
                    <?php if (!$_smarty_tpl->getVariable('notify')->value){?>
...
" class="btn btn-sm label label-danger" style="padding:10px;float:left;margin-left:5px;" onclick="$('#fbMsgType<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbFILES_img<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbFILES_video<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbFILES_audio<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbSaveMsg<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbmsgview<?php echo $_smarty_tpl->getVariable('G')->value;?>
').html('');"><i class="fa fa-fw fa-trash"></i></span>
                </div>
                <div class="card-body" style="margin-top:5px;">
                    <div class="card-button">
                        <div id="fbBtnGrp<?php echo $_smarty_tpl->getVariable('G')->value;?>
" class="button-group" msgctn="<?php echo $_smarty_tpl->getVariable('G')->value;?>
" style="width:300px;">
                            <select id="fbMsgType<?php echo $_smarty_tpl->getVariable('G')->value;?>
" name="fields[subject][type_<?php echo $_smarty_tpl->getVariable('G')->value;?>
]" msgctn="<?php echo $_smarty_tpl->getVariable('G')->value;?>
" class="form-control select2" style="margin-top:5px;" onchange="$('#fbFILES_img<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbFILES_video<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbFILES_audio<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbSaveMsg<?php echo $_smarty_tpl->getVariable('G')->value;?>
').val('');$('#fbmsgview<?php echo $_smarty_tpl->getVariable('G')->value;?>
').html('');$('#fbEditMsg<?php echo $_smarty_tpl->getVariable('G')->value;?>
').click();">
                                ...
                                <?php }?>
                                <!--<?php if (!$_smarty_tpl->getVariable('notify')->value||($_smarty_tpl->getVariable('notify')->value&&$_smarty_tpl->getVariable('G')->value==1)){?>
                                    <option value="sticker" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='sticker'){?>selected<?php }?>>貼圖</option>
                                <?php }?>-->
                                <?php if (!$_smarty_tpl->getVariable('notify')->value){?>
                                    <?php if ($_smarty_tpl->getVariable('rows_FB_Template')->value){?><option class="facebook" style="display:block;" value="fb_template" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='fb_template'){?>selected<?php }?>>一般型卡片</option><?php }?>
                                    <?php if ($_smarty_tpl->getVariable('rows_FB_ListTemplate')->value){?><!--<option class="facebook" style="display:block;" value="fb_listtemplate" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='fb_listtemplate'){?>selected<?php }?>>清單卡片(已停用)</option>--><?php }?>
                                    <?php if ($_smarty_tpl->getVariable('rows_FB_BtnTemplate')->value){?><option class="facebook" style="display:block;" value="fb_btntemplate" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='fb_btntemplate'){?>selected<?php }?>>按鈕卡片</option><?php }?>
                                    <?php if ($_smarty_tpl->getVariable('rows_FB_SocialTemplate')->value){?><!--<option class="facebook" style="display:block;" value="fb_socialtemplate" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='fb_socialtemplate'){?>selected<?php }?>>社交卡片(已停用)</option>--><?php }?>
                                    <?php if ($_smarty_tpl->getVariable('rows_FB_MediaTemplate')->value){?><option class="facebook" style="display:block;" value="fb_mediatemplate" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='fb_mediatemplate'){?>selected<?php }?>>媒體卡片</option><?php }?>
                                    <?php if ($_smarty_tpl->getVariable('rows_FB_ReceiptTemplate')->value){?><option class="facebook" style="display:block;" value="fb_receipttemplate" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='fb_receipttemplate'){?>selected<?php }?>>收據卡片</option><?php }?>
                                    <?php if ($_smarty_tpl->getVariable('rows_FB_AirlineTemplate')->value){?><!--<option class="facebook" style="display:block;" value="fb_airlinetemplate" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='fb_airlinetemplate'){?>selected<?php }?>>航班卡片(暫不開發)</option>--><?php }?>
                                    <?php if ($_smarty_tpl->getVariable('rows_FB_ProductTemplate')->value){?><!--<option class="facebook" style="display:block;" value="fb_producttemplate" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='fb_producttemplate'){?>selected<?php }?>>產品卡片(暫不開發)</option>--><?php }?>
                                <?php }?>
                                ...
                                <?php if (!$_smarty_tpl->getVariable('notify')->value){?>
                                    ...
                                    <option value="audio" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='audio'){?>selected<?php }?>>語音訊息</option>
                                    <?php if ($_smarty_tpl->getVariable('rows_CustomMessage')->value){?><!--<option value="custom" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('type')->value]=='custom'){?>selected<?php }?>>自訂訊息</option>--><?php }?>
                                <?php }?>
                            </select>
                            <textarea id="fbSaveMsg<?php echo $_smarty_tpl->getVariable('G')->value;?>
...
"><?php echo $_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('value')->value];?>
                            ...
                            <div id="fbmsgview<?php echo $_smarty_tpl->getVariable('G')->value;?>
" style="margin-top: 10px;" class="fbmsgview" onclick="$('#fbEditMsg<?php echo $_smarty_tpl->getVariable('G')->value;?>
').click();"></div>
                        </div>
                    </div>
                </div>
...
<?php if ($_smarty_tpl->getVariable('rows_QuicklyReply')->value&&!$_smarty_tpl->getVariable('notify')->value){?>
    <label>設定快捷語</label>
            ...
            <div class="card-body" style="margin-top:5px;">
                <div class="card-button">
                    <div id="fbBtnGrp5" class="button-group" msgctn="5" style="width:300px;">
                        <textarea id="fbSaveMsg5" class="form-control hide" style="margin-top:5px;" rows="1" name="fields[subject][QuicklyReply]" msgctn="5" placeholder="快捷語"><?php echo $_smarty_tpl->getVariable('row')->value['subject']['QuicklyReply'];?>
</textarea>
    ...
    function fbEditMsg(ctn, action){
        ...
        if(ctn === 5){
            ...
            switch(fbMsgType){
                ...
                case 'image':
                    if(MsgValue){
                        $('#fbShowImageBox #fbpreviews_img'+fbSelectMsg).attr('src', '<?php echo $_smarty_tpl->getVariable('__WEB_UPLOAD')->value;?>
/image/'+MsgValue).show();
                    }
                    $('.fbUploadImage').hide();
                ...
                case 'video':
                    if(MsgValue){
                        $('#fbShowVideoBox #fbpreviews_video'+fbSelectMsg+ ' source').attr('src', '<?php echo $_smarty_tpl->getVariable('__WEB_UPLOAD')->value;?>
/video/'+MsgValue);
                ...
                case 'audio':
                    if(MsgValue){
                        $('#fbShowAudioBox #fbpreviews_audio'+fbSelectMsg+ ' source').attr('src', '<?php echo $_smarty_tpl->getVariable('__WEB_UPLOAD')->value;?>
/audio/'+MsgValue);
...
/js/data.json", function (data) {
            ...
            if(UpdateValue && UpdateValue.replace(/\s+/g,"")!==""){
                ...
                /*$.each(data, function(val) {
                    ...
                    result = result.replace(new RegExp('[\(]('+ valAdj +')[\)]','g'), '<img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/images/emoticon/'+data[val][1]+'"/>');
                });*/
                UpdateValue = result;
            }
...
/js/data.json", function (data) {
        ...
        /*$(".fbImgType>ul>li").click(function () {
            ...
            $('#fbmsgview'+fbSelectMsg).html('<img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
...
/image/'+_subimg+');"><h3>'+ _subtitle +'</h3></div>';
                            addHtml+='</div>';
                        }
                    }
                    break;
...
<div id="fbShowStickerBox" class="modal fade" role="dialog">
    <div class="modal-dialog tag-7">
        ...
        <div class="modal-content">
            ...
            <ul class="nav nav-tabs">
                <?php if (!$_smarty_tpl->getVariable('notify')->value){?>
                    <li class="active"><a href="#fbImgType01" data-toggle="tab" aria-expanded="false"><img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/images/tab_on_1.png"></a></li>   
                    <li class=""><a href="#fbImgType02" data-toggle="tab" aria-expanded="false"><img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/images/tab_on_2.png"></a></li> 
                    <li class=""><a href="#fbImgType03" data-toggle="tab" aria-expanded="false"><img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/images/tab_on_3.png"></a></li>
                <?php }?>
                <!-- 新增貼圖 -->
                <li class="<?php if ($_smarty_tpl->getVariable('notify')->value){?>active<?php }?>"><a href="#fbImgType04" data-toggle="tab" aria-expanded="false"><img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/images/tab_on_4.png"></a></li>
                <li class=""><a href="#fbImgType05" data-toggle="tab" aria-expanded="true"><img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/images/tab_on_5.png"></a></li>
                <li class=""><a href="#fbImgType06" data-toggle="tab" aria-expanded="true"><img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/images/tab_on_6.png"> </a></li>
                <li class=""><a href="#fbImgType07" data-toggle="tab" aria-expanded="true"><img src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/images/tab_on_7.png"> </a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane fade fbImgType <?php if (!$_smarty_tpl->getVariable('notify')->value){?>active in<?php }?>" id="fbImgType01">
                    <ul>
                ...
                <!-- 新增貼圖 -->
                <div class="tab-pane fade fbImgType <?php if ($_smarty_tpl->getVariable('notify')->value){?>active in<?php }?>" id="fbImgType04">
                    <ul>
...
for ($_smarty_tpl->tpl_vars['G']->value = 0, $_smarty_tpl->tpl_vars['G']->iteration = 1;$_smarty_tpl->tpl_vars['G']->iteration <= $_smarty_tpl->tpl_vars['G']->total;$_smarty_tpl->tpl_vars['G']->value += $_smarty_tpl->tpl_vars['G']->step, $_smarty_tpl->tpl_vars['G']->iteration++){
$_smarty_tpl->tpl_vars['G']->first = $_smarty_tpl->tpl_vars['G']->iteration == 1;$_smarty_tpl->tpl_vars['G']->last = $_smarty_tpl->tpl_vars['G']->iteration == $_smarty_tpl->tpl_vars['G']->total;?>
                    <div id="fbUploadImage<?php echo $_smarty_tpl->getVariable('G')->value;?>
" class="fbUploadImage">
                        <label class="btn btn-info" style="float:right;">
                            <input style="display:none;" id="fbFILES_img<?php echo $_smarty_tpl->getVariable('G')->value;?>
...
', 'fb');" type="file">
                        ...
                        <img style="width:300px;height:200px;display: none;" class="img-thumbnail1" id="fbpreviews_img<?php echo $_smarty_tpl->getVariable('G')->value;?>
" src=""/>
                    </div>
                <?php }} ?>
            </div>
...
for ($_smarty_tpl->tpl_vars['G']->value = 0, $_smarty_tpl->tpl_vars['G']->iteration = 1;$_smarty_tpl->tpl_vars['G']->iteration <= $_smarty_tpl->tpl_vars['G']->total;$_smarty_tpl->tpl_vars['G']->value += $_smarty_tpl->tpl_vars['G']->step, $_smarty_tpl->tpl_vars['G']->iteration++){
$_smarty_tpl->tpl_vars['G']->first = $_smarty_tpl->tpl_vars['G']->iteration == 1;$_smarty_tpl->tpl_vars['G']->last = $_smarty_tpl->tpl_vars['G']->iteration == $_smarty_tpl->tpl_vars['G']->total;?>
                    <div id="fbUploadVideo<?php echo $_smarty_tpl->getVariable('G')->value;?>
" class="fbUploadVideo">
                        <label class="btn btn-info" style="float:right;">
                            <input style="display:none;" id="fbFILES_video<?php echo $_smarty_tpl->getVariable('G')->value;?>
" class="form-control" name="value_<?php echo $_smarty_tpl->getVariable('G')->value;?>
" onchange="init_inputVideo(this, '<?php echo $_smarty_tpl->getVariable('G')->value;?>
', 'fb');" type="file" accept="video/mp4" maxsize="200MB">
                            <i class="fa fa-photo"></i>上傳影片
                        </label>
                        <video style="width:300px;height:200px;display: none;" class="img-thumbnail1" id="fbpreviews_video<?php echo $_smarty_tpl->getVariable('G')->value;?>
...
for ($_smarty_tpl->tpl_vars['G']->value = 0, $_smarty_tpl->tpl_vars['G']->iteration = 1;$_smarty_tpl->tpl_vars['G']->iteration <= $_smarty_tpl->tpl_vars['G']->total;$_smarty_tpl->tpl_vars['G']->value += $_smarty_tpl->tpl_vars['G']->step, $_smarty_tpl->tpl_vars['G']->iteration++){
$_smarty_tpl->tpl_vars['G']->first = $_smarty_tpl->tpl_vars['G']->iteration == 1;$_smarty_tpl->tpl_vars['G']->last = $_smarty_tpl->tpl_vars['G']->iteration == $_smarty_tpl->tpl_vars['G']->total;?>
                    <div id="fbUploadAudio<?php echo $_smarty_tpl->getVariable('G')->value;?>
" class="fbUploadAudio">
                        <label class="btn btn-info" style="float:right;">
                            <input style="display:none;" id="fbFILES_audio<?php echo $_smarty_tpl->getVariable('G')->value;?>
" class="form-control" name="value_<?php echo $_smarty_tpl->getVariable('G')->value;?>
" onchange="init_inputAudio(this, '<?php echo $_smarty_tpl->getVariable('G')->value;?>
', 'fb');" type="file" accept="audio/x-m4a, audio/mp3" maxsize="10MB">
                            <i class="fa fa-photo"></i>上傳語音訊息
                        </label>
                        <audio class="img-thumbnail1" id="fbpreviews_audio<?php echo $_smarty_tpl->getVariable('G')->value;?>
