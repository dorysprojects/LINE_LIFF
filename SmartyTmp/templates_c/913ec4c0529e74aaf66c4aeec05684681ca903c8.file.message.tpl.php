<?php /* Smarty version Smarty3-b7, created on 2021-10-25 15:19:56
         compiled from "/home1/rickytest.gadclubs.com/CustomStickers/library/modules/_public/view/type/message.tpl" */ ?>
<?php /*%%SmartyHeaderCode:165170848961765a9c8a2581-71811210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '913ec4c0529e74aaf66c4aeec05684681ca903c8' => 
    array (
      0 => '/home1/rickytest.gadclubs.com/CustomStickers/library/modules/_public/view/type/message.tpl',
      1 => 1635140958,
    ),
  ),
  'nocache_hash' => '165170848961765a9c8a2581-71811210',
  'function' => 
  array (
  ),
    ...
    function UpdateMsg(NowSelectMsg=SelectMsg, action){
        if(action!=='hand'){
            for (const [key, item] of Object.entries(CompareList)) {
                $('#ShowTextBox .emojionearea>.emojionearea-editor').html($('#ShowTextBox .emojionearea>.emojionearea-editor').html().replaceAll(key, item));
            };
        }
...
';
                    ...
                    //result = result.replace(new RegExp('[\(]('+ emoticonId +')[\)]','g'), ContentHtml);
                });
            }
            for (const [key, item] of Object.entries(CompareList)) {
...
/images/emoticon/'+data[val][1]+'"/>');
                ...
                emoticonList.forEach(function(emoticonId){
                    ...
                    var _packageId = Tmp[0];
                    var _emojiId = Tmp[1];
                    result = result.replace(new RegExp('[\(]('+ emoticonId +')[\)]','g'), '<img style="width:39px;height:39px;" src="<?php echo $_smarty_tpl->getVariable('EmojiLink_Path')->value;?>
'+_packageId+'<?php echo $_smarty_tpl->getVariable('EmojiLink_OS')->value;?>
'+_emojiId+'<?php echo $_smarty_tpl->getVariable('EmojiLink_Extension')->value;?>
">');
                });
            ...
            //$('#msgview'+NowSelectMsg).html(UpdateValue);
            $('#msgview'+NowSelectMsg).html(TranslateEmoji(UpdateValue));
        });*/
    }
</script>
...
/js/data.json", function (data) {
        ...
        $(".ImgType>ul>li").click(function () {
            ...
            $('#msgview'+SelectMsg).html('<img style="width:75px;height:70px;" src="<?php echo $_smarty_tpl->getVariable('StickerLink_Path')->value;?>
...
/image/'+_subimg+');"></span>';
                ...
                case 'CustomMessage':
                    ...
                    xajax_BuildMsg('return', '', 'next', 'type', 'message', MsgVal, 'MemberInfo', 'msgview'+SelectMsg);
                    break;
                case 'FB_Template':
                    var Template = JSON.parse($(this).attr('data-json'));
                    for (i = 0; i < 10; i++) {
...
?>
                            <?php if (!$_smarty_tpl->getVariable('notify')->value||($_smarty_tpl->getVariable('notify')->value&&($_smarty_tpl->getVariable('packageId')->value==1||$_smarty_tpl->getVariable('packageId')->value==2||$_smarty_tpl->getVariable('packageId')->value==3||$_smarty_tpl->getVariable('packageId')->value==4))){?>
                                <li class="<?php if ($_smarty_tpl->getVariable('packageId')->value=='5ac1bfd5040ab15980c9b435'){?>active<?php }?>" onclick="$('#EmojiType<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
...
" data-toggle="tab" aria-expanded="true">
                                        <img style="width:34px;height:29px;" src="<?php echo $_smarty_tpl->getVariable('EmojiLink_Path')->value;?>
<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
<?php echo $_smarty_tpl->getVariable('EmojiLink_OS')->value;?>
001<?php echo $_smarty_tpl->getVariable('EmojiLink_Extension')->value;?>
">
                                    </a>
                                </li>
                            <?php }?>
...
?>
                        <?php if (!$_smarty_tpl->getVariable('notify')->value||($_smarty_tpl->getVariable('notify')->value&&($_smarty_tpl->getVariable('packageId')->value==1||$_smarty_tpl->getVariable('packageId')->value==2||$_smarty_tpl->getVariable('packageId')->value==3||$_smarty_tpl->getVariable('packageId')->value==4))){?>
                            <div class="tab-pane fade EmojiType <?php if ($_smarty_tpl->getVariable('packageId')->value=='5ac1bfd5040ab15980c9b435'){?>active in<?php }?>" id="EmojiType<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
">
                                <ul>
...
" src="<?php if ($_smarty_tpl->getVariable('packageId')->value=='5ac1bfd5040ab15980c9b435'){?><?php echo $_smarty_tpl->getVariable('EmojiLink_Path')->value;?>
<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
<?php echo $_smarty_tpl->getVariable('EmojiLink_OS')->value;?>
<?php echo $_smarty_tpl->getVariable('emojiId')->value;?>
<?php echo $_smarty_tpl->getVariable('EmojiLink_Extension')->value;?>
...
if (count($_from) > 0){
 ...
 $_smarty_tpl->tpl_vars['packageId']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
                    <li class="<?php if ($_smarty_tpl->getVariable('packageId')->value==1){?>active<?php }?>" onclick="var OldActiveSrc=$('#ShowStickerBox .nav-tabs li.active>a>img').attr('src');
...
" data-toggle="tab" aria-expanded="true">
                            <img style="width:34px;height:29px;" src="<?php echo $_smarty_tpl->getVariable('StickerPageLink_Path')->value;?>
<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
...
if (count($_from) > 0){
 ...
 $_smarty_tpl->tpl_vars['packageId']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
                    <div class="tab-pane fade ImgType <?php if ($_smarty_tpl->getVariable('packageId')->value==1){?>active in<?php }?>" id="ImgType<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
">
                        <ul>
...
" src="<?php if ($_smarty_tpl->getVariable('packageId')->value==1){?><?php echo $_smarty_tpl->getVariable('StickerLink_Path')->value;?>
<?php echo $_smarty_tpl->getVariable('stickerId')->value;?>
<?php echo $_smarty_tpl->getVariable('StickerLink_File')->value;?>
<?php }?>">
                                    </li>
