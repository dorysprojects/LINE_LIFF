<?php /* Smarty version Smarty3-b7, created on 2022-10-21 11:25:08
         compiled from "/home1/bot.lineapie.tw/library/modules/backend/view/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:163651911263521114ace055-62302773%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '949ef6da86c64c9322890d4d4e1685642548a033' => 
    array (
      0 => '/home1/bot.lineapie.tw/library/modules/backend/view/index.tpl',
      1 => 1660702866,
    ),
  ),
  'nocache_hash' => '163651911263521114ace055-62302773',
  'function' => 
  array (
  ),
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">
                                        <?php if ($_smarty_tpl->getVariable('BoxTitle')->value){?>
                                            <?php echo $_smarty_tpl->getVariable('BoxTitle')->value;?>

                                            <br><br>
                                        <?php }?>
                                        <?php echo $_smarty_tpl->getVariable('LeftCustomBtn')->value;?>

                                    </h3>
                                    <div class="box-tools pull-right">
                                        <?php echo $_smarty_tpl->getVariable('TopCustomEdit')->value;?>

                                        <a class="btn btn-info btn-sm <?php if ($_smarty_tpl->getVariable('noadd')->value){?>hide<?php }?>" href="/be/<?php echo $_smarty_tpl->getVariable('_Module')->value;?>
...
" <?php if ($_smarty_tpl->getVariable('rowitem')->value[$_smarty_tpl->getVariable('columnkey')->value]==$_smarty_tpl->getVariable('optionkey')->value){?>checked<?php }?> onchange="$(this).parent().hide();$(this).parent().parent().find('.view').html($(this).attr('label')).show();"><?php echo $_smarty_tpl->getVariable('optionitem')->value;?>
                                                        ...
                                                        <td <?php if ($_smarty_tpl->getVariable('noedit')->value||$_smarty_tpl->getVariable('rowitem')->value['noedit']){?>class="hide"<?php }?>>
                                                            <?php if ($_smarty_tpl->getVariable('rowitem')->value['CustomEditUrl']){?>
                                                                <?php $_smarty_tpl->assign('EditUrl',$_smarty_tpl->getVariable('rowitem')->value['CustomEditUrl'],null,null);?>
                                                            <?php }else{ ?>
                                                                <?php $_smarty_tpl->assign('EditUrl',smarty_modifier_cat(smarty_modifier_cat(smarty_modifier_cat('/be/',$_smarty_tpl->getVariable('_Module')->value),'/edit/id/'),$_smarty_tpl->getVariable('rowitem')->value['id']),null,null);?>
                                                                <?php if ($_smarty_tpl->getVariable('__TYPE')->value){?>
                                                                    <?php $_smarty_tpl->assign('EditUrl',smarty_modifier_cat(smarty_modifier_cat($_smarty_tpl->getVariable('EditUrl')->value,'/type/'),$_smarty_tpl->getVariable('__TYPE')->value),null,null);?>
                                                                <?php }?>
                                                            <?php }?>
                                                            <a href="<?php echo $_smarty_tpl->getVariable('EditUrl')->value;?>
" class="btn btn-info btn-sm">
                                                            ...
                                                            <?php }?>
                                                            <?php if ($_smarty_tpl->getVariable('rowitem')->value['list']){?>
                                                                <?php echo $_smarty_tpl->getVariable('rowitem')->value['list'];?>
