<?php /* Smarty version Smarty3-b7, created on 2021-12-16 16:57:58
         compiled from "/home1/rickytest.gadclubs.com/CustomStickers/library/modules/_public/view/type/quicklyreply.tpl" */ ?>
<?php /*%%SmartyHeaderCode:39187196961baff96f2f131-39611991%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d68bc297c42cfbca7d631faef76209031c765f3' => 
    array (
      0 => '/home1/rickytest.gadclubs.com/CustomStickers/library/modules/_public/view/type/quicklyreply.tpl',
      1 => 1639622570,
    ),
  ),
  'nocache_hash' => '39187196961baff96f2f131-39611991',
  'function' => 
  array (
  ),
...
<div class="TemplateContainer" style="overflow:auto;<?php if ($_smarty_tpl->getVariable('__TYPE')->value=='facebook'){?>background-color:#fff;border:none;<?php }?>">
    <div class="TemplateSlider" style="width:3200px;">
        <input type="hidden" name="fields[next]" value="<?php if ($_smarty_tpl->getVariable('__TYPE')->value=='facebook'){?>facebook<?php }else{ ?>line<?php }?>">
...
');"><i class="fa fa-fw fa-arrow-right"></i></span>
                    <?php }?>
                    <span id="DeleteMsg_5" class="btn btn-sm label label-danger" style="padding:10px;float:left;margin-left:5px;" onclick="ClearData('<?php echo $_smarty_tpl->getVariable('G')->value;?>
...
_<?php echo $_smarty_tpl->getVariable('N')->value;?>
                                ...
                                <?php if ($_smarty_tpl->getVariable('__TYPE')->value!='facebook'){?>
                                    <option value="hyperlink" <?php if ($_smarty_tpl->getVariable('row')->value['subject'][$_smarty_tpl->getVariable('action')->value]=='hyperlink'){?>selected<?php }?>>超連結</option>
                                <?php }?>
