<?php /* Smarty version Smarty3-b7, created on 2022-01-04 17:29:28
         compiled from "/home1/bot.gadclubs.com//library/modules/backend/view/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:47060320661d41378ba2539-27092164%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0acba0291f401dc835a601e4075d37f1d81965de' => 
    array (
      0 => '/home1/bot.gadclubs.com//library/modules/backend/view/index.tpl',
      1 => 1641288363,
    ),
  ),
  'nocache_hash' => '47060320661d41378ba2539-27092164',
  'function' => 
  array (
  ),
...
" <?php if ($_smarty_tpl->getVariable('rowitem')->value[$_smarty_tpl->getVariable('columnkey')->value]==$_smarty_tpl->getVariable('optionkey')->value){?>checked<?php }?> onchange="$(this).parent().hide();$(this).parent().parent().find('.view').html($(this).attr('label')).show();"><?php echo $_smarty_tpl->getVariable('optionitem')->value;?>
                                                        ...
                                                        <td <?php if ($_smarty_tpl->getVariable('noedit')->value||$_smarty_tpl->getVariable('rowitem')->value['noedit']){?>class="hide"<?php }?>>
                                                            <a href="/be/<?php echo $_smarty_tpl->getVariable('_Module')->value;?>
