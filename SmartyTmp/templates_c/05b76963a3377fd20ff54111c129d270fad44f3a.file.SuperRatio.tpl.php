<?php /* Smarty version Smarty3-b7, created on 2021-11-03 17:46:51
         compiled from "/home1/rickytest.gadclubs.com/CustomStickers/library/modules/frontend/view/SuperRatio.tpl" */ ?>
<?php /*%%SmartyHeaderCode:177917571761825a8b2f32e8-39170387%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05b76963a3377fd20ff54111c129d270fad44f3a' => 
    array (
      0 => '/home1/rickytest.gadclubs.com/CustomStickers/library/modules/frontend/view/SuperRatio.tpl',
      1 => 1627623102,
    ),
  ),
  'nocache_hash' => '177917571761825a8b2f32e8-39170387',
  'function' => 
  array (
  ),
...
/StartTimer.mp3" type="audio/mpeg">
                                </audio>
                                <audio id="QuickTimerSound" class="hide" controls>
                                    <source src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/QuickTimer.mp3" type="audio/mpeg">
                                </audio>
                                <audio id="EndTimerSound" class="hide" controls>
                                    <source src="<?php echo $_smarty_tpl->getVariable('__RES_Web')->value;?>
/EndTimer.mp3" type="audio/mpeg">
                                </audio>
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-default">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">
                                                    題目列表
                                                    (<span id="QuestionListCtn"><?php echo count($_smarty_tpl->getVariable('rows')->value);?>
</span>/<span id="QuestionListTotal"><?php echo count($_smarty_tpl->getVariable('rows')->value);?>
</span>)
                                                </h3>
                                                <div class="box-tools pull-right">
                                                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
...
?>
                                                        <div class="label label-default label-success"><?php echo $_smarty_tpl->getVariable('item')->value['propertyA'];?>
</div>
                                                    <?php }} ?>
                                                </div>
                                            </div>
