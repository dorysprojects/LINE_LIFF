<?php /* Smarty version Smarty3-b7, created on 2023-06-19 11:59:11
         compiled from "/home1/bot.lineapie.tw/library/modules/backend/view/CustomerService/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1071381018648fd28f29d061-97628466%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5db0f413ac8d89ef4b95a3aec7e754551918824e' => 
    array (
      0 => '/home1/bot.lineapie.tw/library/modules/backend/view/CustomerService/index.tpl',
      1 => 1687147148,
    ),
  ),
  'nocache_hash' => '1071381018648fd28f29d061-97628466',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_date_format')) include '/home1/bot.lineapie.tw/library/plugin/smarty/class/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html >
    <head>
                ...
                <div class="chatapp__sidebar">
                    <ul class="nav" id="myTab" role="tablist">
                        <?php if ($_smarty_tpl->getVariable('LineChat')->value){?>
                            <li class="nav-item">
                                <a class="nav-link <?php if ($_smarty_tpl->getVariable('ChatRoom')->value=='line'){?>active<?php }?>" style="color: <?php if ($_smarty_tpl->getVariable('ChatRoom')->value=='line'){?>#00b900<?php }else{ ?>#949aa2<?php }?>;" href="/be/CustomerService/index/ChatRoom/line">
                        ...
                        <?php if ($_smarty_tpl->getVariable('FacebookChat')->value){?>
                            <li class="nav-item <?php if ($_smarty_tpl->getVariable('ChatRoom')->value=='facebook'){?>facebook<?php }?>">
                                <a class="nav-link" style="color: <?php if ($_smarty_tpl->getVariable('ChatRoom')->value=='facebook'){?>#628cc1<?php }else{ ?>#949aa2<?php }?>;" href="/be/CustomerService/index/ChatRoom/facebook">
                                    <!--<i class="mdi mdi-message-text-outline"></i>-->
                            ...
                            <div class="chatapp-user-list-body custom-scrollbar ps ps--active-y">
                                <div class="chatapp__headingbar">
                                    ...
                                    <div class="chatapp__actions">
                                        <?php if ($_smarty_tpl->getVariable('TagsOptions')->value){?>
                                    ...
                                    <?php if ($_smarty_tpl->getVariable('TagsOptions')->value){?>
                                        <div class="box box-warning">
                                            ...
                                            <div id="FilterTagsBody" class="box-body">
                                                <?php  $_smarty_tpl->tpl_vars['tvalue'] = new Smarty_Variable;
 $_smarty_tpl->tpl_vars['tkey'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('TagsOptions')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if (count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['tvalue']->key => $_smarty_tpl->tpl_vars['tvalue']->value){
 $_smarty_tpl->tpl_vars['tkey']->value = $_smarty_tpl->tpl_vars['tvalue']->key;
?>
                                                    <input id="FilterTags<?php echo $_smarty_tpl->getVariable('tkey')->value;?>
" type="checkbox" name="fields[content][filter][Tags][]" value="<?php echo $_smarty_tpl->getVariable('tkey')->value;?>
">
                                                    <label for="FilterTags<?php echo $_smarty_tpl->getVariable('tkey')->value;?>
"><?php echo $_smarty_tpl->getVariable('tvalue')->value;?>
</label>
                                                <?php }} ?>
                                            </div>
                                        </div>
...
?>
                                                    <li onclick="$('.ImgType').hide();$('#ImgType<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
').show();
                                                                    $('#ShowStickerBox .nav-tabs li>a>img').each(function(e){ $(this).attr('src', $(this).attr('<?php echo $_smarty_tpl->getVariable('StickerTabOff')->value;?>
')); });
...
" data-toggle="tab" aria-expanded="true">
                                                            <img tab_on="<?php echo $_smarty_tpl->getVariable('StickerPageLink_Path')->value;?>
...
if (count($_from) > 0){
 ...
 $_smarty_tpl->tpl_vars['packageId']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
                                                    <li onclick="$('.EmojiType').hide();$('#EmojiType<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
').show();
                                                                    $('#ShowEmojiBox .nav-tabs li>a>img').each(function(e){ $(this).attr('src', $(this).attr('<?php echo $_smarty_tpl->getVariable('EmojiTabOff')->value;?>
')); });
...
<?php echo $_smarty_tpl->getVariable('EmojiLink_Extension')->value;?>
"
                                                                src="<?php echo $_smarty_tpl->getVariable('EmojiPageLink_Path')->value;?>
<?php echo $_smarty_tpl->getVariable('packageId')->value;?>
<?php echo $_smarty_tpl->getVariable('EmojiLink_OS')->value;?>
<?php echo $_smarty_tpl->getVariable('EmojiTabOff')->value;?>
<?php echo $_smarty_tpl->getVariable('StickerPageLink_Extension')->value;?>
                                            ...
                                            <script>
                                                ...
                                                $(function () {
                                                    $(document).on('click', '.EmojiType>ul>li', function (event) {
                                                        ...
                                                        InsertEmoji(ContentData);//ContentData
                                                    });
                                                ...
                                                window.setTimeout(function () {
                                                    $(document).on('click keyup', '#SendBox>.emojionearea>.emojionearea-editor', function (event) {
                                                ...
                                                function InsertEmoji(Content) {
                                                    if (SelectionRange) {
                                                        console.log(SelectionRange);
                                                        var boundaryRange = SelectionRange.cloneRange(),
                                                            insertTextNode = document.createTextNode(Content);
                                                        if(SelectionRange) SelectionRange.deleteContents();
                                                        boundaryRange.insertNode(insertTextNode);
                                                        SelectionRange = null;
                                                        $('#SendBox>.emojionearea>.emojionearea-editor').focus().blur();
                                                    }
                                                }
                                            </script>
                                        </div>
                                ...
                                <div class="information-panel__body custom-scrollbar ps">
                                    <div class="userprofile-avatar">
                                        <div id="MemberImg" style='border-radius: 6.25rem;
                                                                    ...
                                                                    background-repeat: no-repeat;
                                                                    background-image: url("<?php echo $_smarty_tpl->getVariable('__PLUGIN_Web')->value;?>
/Chatriq/img/01.jpg"), url("/library/res/images/person.jpg");'></div>
                                    </div>
...
"></script>
        ...
        <script type="text/javascript">
            var __CustomStickers_Web = '<?php echo $_smarty_tpl->getVariable('__CustomStickers_Web')->value;?>
';
            function OpenMsg(){
