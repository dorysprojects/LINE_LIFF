<?php /* Smarty version Smarty3-b7, created on 2021-08-12 22:19:17
         compiled from "/home1/rickytest.gadclubs.com/CustomStickers/library/modules/frontend/view/place.tpl" */ ?>
<?php /*%%SmartyHeaderCode:175465875461152de52c8ca7-69688202%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b3a868d1983442832971b2f34a7bc9cc9241ffa0' => 
    array (
      0 => '/home1/rickytest.gadclubs.com/CustomStickers/library/modules/frontend/view/place.tpl',
      1 => 1627623076,
    ),
  ),
  'nocache_hash' => '175465875461152de52c8ca7-69688202',
  'function' => 
  array (
  ),
...
';
                ...
                var _RecordInnerHtml = '<p>'+
                                        ...
                                        '<hr>';
                var _RecordHtml =   '<div class="recordItem" data-Name="'+ _ManagerList[PlaceItem['propertyA']]['subject']['displayName'] +'" data-UID="'+ PlaceItem['propertyA'] +'" data-id="'+ PlaceItem['propertyB'] +'" data-json='+ "'"+JSON.stringify(PlaceItem['subject'])+"'" +'>'+
                                        _RecordInnerHtml+
                                    '</div>';
                ...
                var _InnerHTML = '<p>'+
                                ...
                                '<a target="_blank" href="https://www.google.com.tw/maps/dir//'+PlaceItem['subject']['name']+' '+PlaceItem['subject']['formatted_address']+'/@'+PlaceItem['subject']['geometry']['location']['lat']+','+PlaceItem['subject']['geometry']['location']['lng']+',12z"><div><i class="fa fa-fw fa-map-marker" style="color: #4285f4;"></i> '+ PlaceItem['subject']['formatted_address'] +'</div></a>'+
                                '<hr>';
                var _Html = '<div class="placeItem" data-Name="'+ _ManagerList[PlaceItem['propertyA']]['subject']['displayName'] +'" data-UID="'+ PlaceItem['propertyA'] +'" data-id="'+ PlaceItem['propertyB'] +'" data-json='+ "'"+JSON.stringify(PlaceItem['subject'])+"'" +'>'+
                                _InnerHTML+
                            '</div>';
                if(act==='build'){
                    if(from==='start'){
                    ...
                    $('.placeItem[data-UID="'+ PlaceItem['propertyA'] +'"][data-id="'+ PlaceItem['propertyB'] +'"]').attr('data-json', JSON.stringify(PlaceItem['subject'])).html(_InnerHTML);
                    $('.recordItem[data-UID="'+ PlaceItem['propertyA'] +'"][data-id="'+ PlaceItem['propertyB'] +'"]').attr('data-json', JSON.stringify(PlaceItem['subject'])).html(_RecordInnerHtml);
                }
            }
...
/?sharenote&module=place&admin=' + userId;//module=xxx
            }
        </script>
    </body>
</html>