...
<script src="{#$__PLUGIN_Web#}/signaturepad/vconsole.min.js"></script><!-- vConsole(手機版console[ LIFF適用 ])https://cdn.jsdelivr.net/npm/vconsole -->
<script charset="utf-8" src="https://static.line-scdn.net/liff/edge/2/sdk.js?v={#$smarty.now|date_format:'%Y%m%d%H:%M:%S'#}"></script>
<!-- <script charset="utf-8" src="{#$__PLUGIN_Web#}/signaturepad/sdk-2.1.js"></script><!-- https://static.line-scdn.net/liff/edge/2.1/sdk.js -->
<!--<script src='{#$__PLUGIN_Web#}/signaturepad/jquery-1.8.2.js'></script><!-- https://code.jquery.com/ -->
<!--<script src="{#$__PLUGIN_Web#}/signaturepad/jquery.js"></script><!-- https://cdnjs.cloudflare.com/ajax/libs/jquery/2.0.0/ -->
<!--<script src="{#$__PLUGIN_Web#}/signaturepad/jquery.min.js"></script><!-- https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/ -->
<script src="{#$__PLUGIN_Web#}/signaturepad/axios.min.js"></script><!-- https://unpkg.com/axios/dist/ -->
<script src="{#$__PLUGIN_Web#}/signaturepad/hammer.min.js"></script><!-- https://hammerjs.github.io/dist/ -->

{#if $_Module=='sticker'#}
    <script src="{#$__PLUGIN_Web#}/signaturepad/signature_pad.min.js"></script><!-- https://cdn.jsdelivr.net/npm/signature_pad@2.3.2/dist/ -->
    <script src="{#$__PLUGIN_Web#}/signaturepad/jscolor.js"></script>
    <script src="{#$__PLUGIN_Web#}/signaturepad/ga.js"></script>
    <script src="{#$__PLUGIN_Web#}/signaturepad/signature_pad.umd.js"></script>
    <script src="{#$__PLUGIN_Web#}/signaturepad/app.js?{#$smarty.now|date_format:'%Y%m%d%H:%M:%S'#}"></script>
    <script src="{#$__PLUGIN_Web#}/signaturepad/farbtastic3.js" type="text/javascript"></script>
{#/if#}
...
<script>
    ...
    function SelectProject(obj) {
        ...
        location.href = '{#$__CustomStickers_Web#}/ft/' + project + '?project=' + projectName + '&pic_url=' + pic_url;
    }
