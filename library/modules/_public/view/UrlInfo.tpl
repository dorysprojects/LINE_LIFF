            ...
            <div class="modal-body" style="-webkit-user-select:text;-moz-user-select:text;-o-user-select:text;user-select:text;padding-bottom: 0px;">
                ...
                <div class="alert alert-info">
                    <ul class="fa-ul">
                        <li>
                            <i class="fa fa-info-circle fa-lg fa-li"></i>
                            <span class="remark">前往Line@(<font color="#FF0000">https://line.me/R/ti/p/【Line@ID】</font>)<br>範例:<font color="#FF0000">https://line.me/R/ti/p/@{#$__LineAtID#}</font></span>
                        </li>
                    </ul>
                </div>
                <div class="alert alert-info">
                    <ul class="fa-ul">
                        <li>
                            <i class="fa fa-info-circle fa-lg fa-li"></i>
                            <span class="remark">前往Line@並帶上文字(<font color="#FF0000">https://line.me/R/oaMessage/【Line@ID】/?【要帶上的文字】</font>)<br>範例:<font color="#FF0000">https://line.me/R/oaMessage/@{#$__LineAtID#}/?好康分享%0D%0Ahttps://www.google.com</font></span>
                        </li>
                    </ul>
                </div>
