...
<div class="row" style="margin: 0px;">
    ...
    <div class="col-md-12">
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <div class="SampleMessage btn btn-dropbox"    _type="video"          _msgtype="video-message"    data='{ "type": "video", "originalContentUrl": "{#$__RES_Web#}/images/original.mp4", "previewImageUrl": "{#$__RES_Web#}/images/preview.jpg" }'>影片</div>
            ...
            <div class="box-body">
                ...
                <div class="Type image">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6 ExampleJson" Title="Image message example" Json='{ "type":"image","originalContentUrl":"{#$__RES_Web#}/images/original.jpg","previewImageUrl":"{#$__RES_Web#}/images/preview.jpg" }'>
    ...
    <div class="col-md-12">
        {#if $row.subject.data#}
            {#assign var="flexdata" value=json_decode($row.subject.data, true)#}
        {#/if#}
        <iframe id="FlexSimulator" src="{#if $flexdata.type && $flexdata.type==='flex'#}{#$__CustomStickers_Web#}/ft/flex-simulator{#/if#}" style="width: -webkit-fill-available;height: 100vh;display: none;"></iframe>
    </div>
</div>
...
<script>
                ...
                if( (ask&&confirm('是否要帶入Flex版本?')) || (!ask&&JSON.parse(_Json)['type']==='flex') ){
                    ...
                    if(JSON.parse(flexData)['type']==='flex'){
                        ...
                        if(!$('#FlexSimulator').attr('src')){
                            loaded = false;
                            $('#FlexSimulator').attr('src', '{#$__CustomStickers_Web#}/ft/flex-simulator');
                        }
                        if(loaded && ask){
    ...
    $(function(){
        ...
        {#if $row.subject.data#}
            SampleMessageClick($(".SampleMessage[_type='{#$row.propertyA#}']"), false, {#json_encode($row.subject.data)#});
        {#/if#}
    });
</script>