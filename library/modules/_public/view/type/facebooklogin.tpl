    ...
    function Authorization(obj=null){
        FB.api(
            ...
            function (response) {
                ...
                console.log(response);
                xajax_FilePutContents('{#$__CONFIG#}/__FB_Page_ID', obj.attr('data-pageID'), obj.attr('data-userID'));
                xajax_FilePutContents('{#$__CONFIG#}/__FB_Page_Name', obj.attr('data-name'), obj.attr('data-userID'));
                xajax_FilePutContents('{#$__CONFIG#}/__FB_Page_Token', obj.attr('data-pageToken'), obj.attr('data-userID'));
                xajax_FilePutContents('{#$__CONFIG#}/__FB_Page_Picture', $("#LinkedList img#page-"+obj.attr('data-pageID')).attr('src'), obj.attr('data-userID'));
                if (response.success) {
                    alert('已成功連動');
                }else{
