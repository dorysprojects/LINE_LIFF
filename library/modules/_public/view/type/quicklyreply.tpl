...
<div class="TemplateContainer" style="overflow:auto;{#if $__TYPE=='facebook'#}background-color:#fff;border:none;{#/if#}">
    <div class="TemplateSlider" style="width:3200px;">
        <input type="hidden" name="fields[next]" value="{#if $__TYPE=='facebook'#}facebook{#else#}line{#/if#}">
        {#for $G=0 to 9#}
            ...
            <div class="col-lg-4 Template" style="display:inline-block;width:300px;margin: 10px;text-align:center;">
                <div class="TemplateBtn" style="width:300px;height:35px;">
                    ...
                    {#/if#}
                    <span id="DeleteMsg_5" class="btn btn-sm label label-danger" style="padding:10px;float:left;margin-left:5px;" onclick="ClearData('{#$G#}');"><i class="fa fa-fw fa-trash"></i></span>
                    ...
                    <div class="card-button">
                        ...
                        <div class="button-group" style="width:300px;">
                            ...
                            <select name="fields[subject][action{#$G#}_{#$N#}]" class="form-control select2" style="margin-top:5px;">
                                ...
                                {#if $__TYPE!='facebook'#}
                                    <option value="hyperlink" {#if $row.subject.$action=='hyperlink'#}selected{#/if#}>超連結</option>
                                {#/if#}
