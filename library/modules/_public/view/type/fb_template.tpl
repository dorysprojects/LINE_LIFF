        ...
        {#for $G=0 to 9#}
            ...
            <div class="col-lg-4 Template" style="display:inline-block;width:300px;margin: 10px;text-align:center;">
                ...
                <div class="card-body" style="margin-top:5px;">
                    <input name="fields[subject][subtitle{#$G#}]" type="text" maxlength="80" value="{#$row.subject.$subtitle#}" class="form-control" style="width:300px;" placeholder="標題">
                    <textarea name="fields[subject][subcontent{#$G#}]" rows="1" maxlength="80" class="form-control" style="width:300px;margin-top:5px;" placeholder="描述">{#$row.subject.$subcontent#}</textarea>
