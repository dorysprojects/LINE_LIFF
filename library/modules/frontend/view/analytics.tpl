...
<head>
    ...
    <link rel="icon" href="{#$__PLUGIN_Web#}/analytics/img/line.png" />
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link href="https://fonts.googleapis.com/css?family=Righteous&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{#$__PLUGIN_Web#}/analytics/style.css?{#$smarty.now|date_format:'%Y%m%d%H:%M:%S'#}">
    ...
    <script defer src="{#$__PLUGIN_Web#}/analytics/src/lib/wordcloud2.js"></script>
    <script defer src="{#$__PLUGIN_Web#}/analytics/src/lib/wordfreq.worker.js"></script>
    <script defer src="{#$__PLUGIN_Web#}/analytics/src/lib/wordfreq.js"></script>
    <script defer src="{#$__PLUGIN_Web#}/analytics/src/lib/rpie.js"></script>
    <script defer src="{#$__PLUGIN_Web#}/analytics/src/analyze.js?{#$smarty.now|date_format:'%Y%m%d%H:%M:%S'#}"></script>
    <script type="text/javascript" src="{#$__PLUGIN_Web#}/analytics/src/lib/jquery-1.9.1.min.js"></script>
    <title>聊天分析</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #7C7877;">
        <a class="navbar-brand" href="{#$__CustomStickers_Web#}/ft/analytics">
            <img src="{#$__PLUGIN_Web#}/analytics/img/line.png" width="30" height="30" class="d-inline-block align-top" alt="">
                ...
                <div class="main-container">
                    ...
                    <div class="image-container">
                        <div class="demo-image mobile-hidden">
                            <img src="{#$__PLUGIN_Web#}/analytics/img/demo1.PNG">
                        </div>
                        <div class="demo-image mobile-hidden">
                            <img src="{#$__PLUGIN_Web#}/analytics/img/demo2.PNG">
                        </div>
                        <div class="demo-image mobile-show demo-mobile">
                            <img src="{#$__PLUGIN_Web#}/analytics/img/demo-mobile.PNG">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ins-image-container">
                        <div class="ins-row">
                            <div class="ins-container">
                                ...
                                <div class="ins-image">
                                    <img src="{#$__PLUGIN_Web#}/analytics/img/info-ios1.jpg">
                                </div>
                            </div>
                            <div class="ins-container">
                                <div class="ins-text">IOS: 再點選右上方齒輪</div>
                                <div class="ins-image">
                                    <img src="{#$__PLUGIN_Web#}/analytics/img/info-ios2.jpg">
                                </div>
                            </div>
                        </div>
                        <div class="ins-row">
                            <div class="ins-container">
                                ...
                                <div class="ins-image">
                                    <img src="{#$__PLUGIN_Web#}/analytics/img/info-android.jpg">
                                </div>
                            </div>
                            <div class="ins-container">
                                <div class="ins-text">最後: 儲存聊天紀錄後再從上方載入聊天</div>
                                <div class="ins-image">
                                    <img src="{#$__PLUGIN_Web#}/analytics/img/info-last.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
