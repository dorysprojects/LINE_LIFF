    ...
    <body onselectstart="return false">
        ...
        <div id="signature-pad" class="signature-pad">
            ...
            <div class="signature-pad--body" style="overflow:auto;">
                <div id="note_list">
                    {#if $note_list#}
                        {#foreach $category_list as $categorykey=>$categoryitem#}
                            <div id="push_category{#$categorykey+1#}" class="category_block" onclick="push_category($(this));" name="{#$categoryitem.propertyB#}" NO="{#$categoryitem.id#}" prevlevel="{#$categoryitem.prev#}" UID="{#$categoryitem.propertyA#}">
                                <div class="category_title">{#$categoryitem.propertyB#}</div>
                                ...
                                {#foreach $subcategory_list as $subcategorykey=>$subcategoryitem#}
                                    {#if $subcategoryitem.prev==$categoryitem.id#}
                                        <div id="push_subcategory{#$subcategorykey+1#}" class="subcategory_block" onclick="push_subcategory($(this));" name="{#$subcategoryitem.propertyB#}" NO="{#$subcategoryitem.id#}" prevlevel="{#$subcategoryitem.prev#}" UID="{#$subcategoryitem.propertyA#}">
                                            <div class="subcategory_title">{#$subcategoryitem.propertyB#}</div>
                ...
                <div id="addarea" style="">
                    ...
                    <div id="add_category" class="EditArea" style="padding:50px 0px;">
                        ...
                        <select id="select_category" class="btn_info word_input">
                            ...
                            {#foreach $category_list as $categorykey=>$categoryitem#}
                                {#if $categoryitem.propertyB != ''#}
                                    <option value="{#$categoryitem.id#}">{#$categoryitem.propertyB#}</option>
                                {#/if#}
                            {#/foreach#}
                        </select>
                        </br></br>
        ...
        <script>
            ...
            function ShareNote(){
                ...
                location.href = 'line://msg/text/?' + Msg + '{#$__CustomStickers_Web#}/ft/sharenote?module=note&admin=' + userId;//module=xxx
            }
