...
<html>
    <head>
        ...
        <style>
            ...
            #SendLineBox .emojionearea.form-control, #FacebookChatBox .emojionearea.form-control {
                height: 34px;
            }
            #LineMessagesArea, #FacebookMessagesArea {
                height: 80vh;
            }
            #LineMsgBox, #FacebookMsgBox {
                display: none;
            }
            #SendLineBox>.input-group-btn, #SendFacebookBox>.input-group-btn {
                font-size: unset;
            }
            #FacebookChatBox {
                right: unset;
    ...
    <body class="ChatRoom hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            {#if $LineChat#}
                                <div id="LineChatBox" class="box box-success direct-chat direct-chat-success direct-chat-contacts-open">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Line客服</h3>
                                        <div class="box-tools pull-right">
                                            <span id="LineRedBubble" data-toggle="tooltip" title="" class="badge bg-red {#if $LineTotalMember==0#}hide{#/if#}">{#$LineTotalMember#}</span>
                                    ...
                                    <div class="box-footer">
                                        <form id="SendLineMsgForm">
                                            <div id="LineMsgBox" class="MsgBox">
                                                {#include file=$__PublicView|cat:'type/message.tpl'#}
                                            </div>
                            ...
                            {#/if#}
                            {#if $FacebookChat#}
                                <div id="FacebookChatBox" class="box box-primary direct-chat direct-chat-success direct-chat-contacts-open">
                                    <div class="box-header with-border">
                                        <h3 class="box-title">Facebook客服</h3>
                                        <div class="box-tools pull-right">
                                            <span id="FacebookRedBubble" data-toggle="tooltip" title="" class="badge bg-red {#if $FacebookTotalMember==0#}hide{#/if#}">{#$FacebookTotalMember#}</span>
                                    ...
                                    <div class="box-footer">            
                                        <form id="SendFacebookMsgForm">
                                            <div id="FacebookMsgBox" class="MsgBox">
                                                {#include file=$__PublicView|cat:'type/fbmessage.tpl'#}
                                            </div>
